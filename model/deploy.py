...
class Predict():
    def __init__(self, path_to_file, path_to_output_file):
        super().__init__()
    ...
    def make_prediction(self):
        ...
        custom_image_pred_class = class_names[torch.argmax(torch.softmax(custom_image_pred, dim=1), dim=1).cpu()] # put pred label to CPU, otherwise will error

        with open(self.path_to_output_file, 'w') as f:
            f.write(custom_image_pred_class)

P1 = Predict("DATA/2.jpg", "DATA/out.txt")
